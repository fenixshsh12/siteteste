...
// Conexão IPv4 forçada (Render não suporta IPv6 puro do Supabase). Usando Username formatado pro Transaction Pooler.
const connectionString = process.env.DATABASE_URL || 'postgresql://postgres.mqcragzxwnmnsksakqph:Caioemyris1.@aws-1-sa-east-1.pooler.supabase.com:5432/postgres?sslmode=disable';
